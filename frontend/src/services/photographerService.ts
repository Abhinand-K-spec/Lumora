...
const photographerService = {
  ...
  uploadCoverPhoto: async (
    file: File,
  ): Promise<ApiResponse<{ coverPhotoUrl: string }>> => {
    const formData = new FormData();
    formData.append("photo", file);
  ...
  addPackage: async (
    ...
    const response = await api.post<
      ApiResponse<{ photographer: PhotographerProfile }>
    >("/photographer/profile/packages", data);
    return response.data;
  },
  ...
  editPackage: async (
    ...
    const response = await api.put<
      ApiResponse<{ photographer: PhotographerProfile }>
    >(`/photographer/profile/packages/${packageId}`, data);
    return response.data;
  },
  ...
  deletePackage: async (
    ...
    const response = await api.delete<
      ApiResponse<{ photographer: PhotographerProfile }>
    >(`/photographer/profile/packages/${packageId}`);
    return response.data;
  },
  ...
  requestApproval: async (): Promise<
    ApiResponse<{ request: ApprovalRequest }>
  > => {
    const response = await api.post<ApiResponse<{ request: ApprovalRequest }>>(
      "/photographer/approval-request",
    );
    return response.data;
  },

  getApprovalHistory: async (): Promise<
    ApiResponse<{ history: ApprovalRequest[] }>
  > => {
