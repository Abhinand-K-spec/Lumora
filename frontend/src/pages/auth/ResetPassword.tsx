      ...
      <main className="flex flex-1 items-center justify-center px-6">
        ...
        >
          ...
          <p className="mt-5 text-center text-s text-secondary leading-relaxed">
            Create a strong password to secure your Lumora account.
          </p>
            ...
            >
              ...
              <div className="mt-5">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`font-medium transition-colors duration-300 ${strength.color}`}
                  >
                    {strength.label}
                  </span>
                </div>
...
const Requirement = ({ valid, text }: RequirementProps) => {
  return (
    <div className="flex items-center gap-3">
      ...
      <p
        className={`
                    ...
                    transition-colors
                    duration-300
                    ${valid ? "text-white" : "text-secondary"}
                    `}
      >
        {text}
      </p>
