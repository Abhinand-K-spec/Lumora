...
const ProfileOverview = ({ name, email, phone }: ProfileOverviewProps) => {
  return (
    <div className="rounded-xl border border-[#292929] bg-[#151515] p-10">
      <h2 className="font-serif text-3xl text-gray-100">Account Settings</h2>

      <div className="mt-10 grid grid-cols-2 gap-7">
        {/* Name */}
        <div>
          <label className="mb-3 block text-sm text-gray-300">Full Name</label>
        ...
        {/* Phone */}
        <div>
          <label className="mb-3 block text-sm text-gray-300">Phone</label>
