...
const PhotographerNarrative = ({
  ...
  const displayVision =
    visionStatement ||
    "No narrative biography added yet. Click 'Edit Profile' to write a bio and share your professional vision!";
    ...
    <div className="bg-[#0f1012] border border-border/20 rounded-xl p-6.5 select-none">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <span
            className="block text-xs font-semibold text-text mt-1 truncate"
            title={displayPhone}
          >
            {displayPhone}
          </span>
